...
// actions
import { getCommonAppSetting, setCommonAppSetting, resetCommonAppSetting } from '../../../actions/CommonSettingAction';
const confirm = Modal.confirm;

class CommonAppSetting extends Component {
    state = {
        config: {}
    }
    ...
    render() {
        ...
        return (
            <div className="formelements-wrapper">
                <PageTitleBar title={<IntlMessages id="sidebar.commonsetting" />} match={this.props.match} />
                <div className="row">
...
function mapDispatchToProps(dispatch) {
    return {
        getConfig: () => dispatch(getCommonAppSetting()),
        setConfig: (data) => dispatch(setCommonAppSetting(data)),
        resetConfig: () => dispatch(resetCommonAppSetting())
    }
}

export default connect(mapStateToProps, mapDispatchToProps)(CommonAppSetting);