...
class AddAdmin extends Component {
  ...
  render() {
    const { onAccountClose, open, account, edit, listGroup } = this.props;
    // var list = listGroup.filter(item =>{
    //   return item.id.toString() !== this.state.groupid.toString()
    // })
          ...
          >
            <Form {...formItemLayout} onSubmit={this.handleSubmit}>
              ...
              {/* <Form.Item label="Group">
                <BaseCheckBoxList data={listGroup} name="groupid" value={this.state.groupid} onChange={this.onSetGroup} />
              </Form.Item> */}
